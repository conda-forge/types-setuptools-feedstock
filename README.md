About types-setuptools-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-setuptools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-setuptools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-setuptools
# for installing globally
pixi global install types-setuptools
```
...
It is possible to list all of the versions of `types-setuptools` available on your platform:
...
```
pixi search types-setuptools --channel conda-forge
```
