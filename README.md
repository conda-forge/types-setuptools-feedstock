...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-setuptools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13231&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-setuptools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-setuptools` can be installed with:

```
conda install types-setuptools
```

It is possible to list all of the versions of `types-setuptools` available on your platform with:
